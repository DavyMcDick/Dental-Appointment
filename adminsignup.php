...
if (isset($_POST['submit'])) {
    ...
    // 🔹 Fix 1: Move empty fields check to the top
    ...
    // 🔹 Fix 3: Insert user data into database
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-6 rounded-lg shadow-lg flex flex-col md:flex-row w-full max-w-4xl">
        ...
        <div class="w-full md:w-2/3 p-6">
            <h2 class="text-xl font-bold mb-2">Admin Sign Up</h2>
            ...
            <p class="text-gray-600 text-sm mt-4">Already have an account? <a href="admin.php" class="text-blue-500">Log in</a></p>
        </div>
    </div>
