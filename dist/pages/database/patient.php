...
$result = $conn->query("SELECT * FROM confirm WHERE status IN ('Confirmed', 'Canceled')");
            ...
            <div class="table-responsive pt-3">
              <table class="table table-bordered" id="appointmentsTable">
                <thead>
                 ...
                 <tbody>
                    <?php
                    $rowsDisplayed = 0; // Counter for displayed rows
                    $maxRows = 6; // Set the maximum rows to display
                    ...
                    ?>
                                    ...
                                    <!-- Sticky Pagination -->
                  <div class="d-flex justify-content-end mt-3 sticky-pagination">
                    <nav aria-label="Page navigation">
                      <ul class="pagination mb-0">
                        <?php if ($page > 1): ?>
                          <li class="page-item">
                            <a class="page-link" href="patient.php?page=<?= $page - 1; ?>" aria-label="Previous">
                        ...
                        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                          <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                            <a class="page-link" href="patient.php?page=<?= $i; ?>">
                              <?= $i; ?>
                            </a>
                          </li>
                        <?php endfor; ?>
                        ...
                        <?php if ($page < $totalPages): ?>
                          <li class="page-item">
                            <a class="page-link" href="patient.php?page=<?= $page + 1; ?>" aria-label="Next">
                              <span aria-hidden="true">»</span>
                            </a>
                          </li>
                        <?php endif; ?>
